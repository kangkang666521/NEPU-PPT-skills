...
| Backend exclusivity | All plotting, previews, exports, and QA renders use Python (matplotlib + seaborn) |
...
If Python plotting packages are unavailable, stop and report the missing runtime/package instead of producing a substitute export.
